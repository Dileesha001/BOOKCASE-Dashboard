...
export default function Header({ 
  ...
  return (
    <header style={{
      ...
      <div>
        <h2 className="heading-display" style={{ fontSize: '1.4rem', margin: 0 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '1.25rem' }}>
            ...
            <div className="glass-card" style={{
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.65rem' }}>
                <div style={{ display: 'flex', gap: '0.65rem', fontSize: '0.8rem' }}>
                  <div className="pulse-dot crimson" style={{ marginTop: '4px' }}></div>
                  <div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <span style={{ fontSize: '0.68rem', color: 'var(--text-gold)', display: 'flex', alignItems: 'center', gap: '3px' }}>
              <ShieldCheck size={11} color="#F7D070" /> Admin Certified
            </span>
          </div>
        </div>
      </div>
